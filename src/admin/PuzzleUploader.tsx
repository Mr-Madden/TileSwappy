...
export const PuzzleUploader: React.FC = () => {
  ...
  const [generatedPuzzles, setGeneratedPuzzles] =
    useState<any[]>([]);
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <select
              ...
              onChange={(e) =>
                setCurrentPuzzle({
                  ...
                  difficulty:
                    e.target
                      .value as PuzzleUpload['difficulty']
                })
              }
              className="w-full border rounded px-3 py-2"
            >
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="bg-teal text-white px-6 py-2 rounded hover:bg-coral"
            >
              {
                isGenerating
                  ? 'Generating...'
