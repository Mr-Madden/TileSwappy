...
export const TileSwappyLogo: React.FC<TileSwappyLogoProps> = ({ size = 120, bouncing = false }) => {
  ...
  return (
    <div {...outerProps}>
      <div
        className="bg-navy-dark rounded-2xl w-full h-full grid grid-cols-2 grid-rows-2 relative"
        style={{
          padding: `${gap}px`,
          gap: `${gap}px`,
        }}
      >
        ...
        <div
          className={`bg-offwhite rounded-xl shadow-lg transition-all duration-[800ms] ease-[cubic-bezier(0.68,-0.35,0.265,1.35)] ${
        ...
        <div
          className={`bg-offwhite rounded-xl shadow-lg transition-all duration-[800ms] ease-[cubic-bezier(0.68,-0.35,0.265,1.35)] relative ${
        ...
        <div
          className={`bg-coral rounded-xl shadow-lg transition-all duration-[800ms] ease-[cubic-bezier(0.68,-0.35,0.265,1.35)] ${
